...
public class InterfaceExamples {
    public static void main(String[] args) {
        ...
        // fly for JetPlane subtracts 5kg fuel
        for (int i = 0; i < 4; i++) {
            for (Airplane p : a) {
                p.fly();
...
class ElectricPlane implements Airplane {
    ...
    public String toString() {
        return "ElectricPlane battery = " + charge + " KW-h";
    }
}

class JetPlane implements Airplane {
    private double charge;

    JetPlane(double charge) {
        this.charge = charge;
    }
    ...
    public String toString() {
        return "JetPlane fuel = " + charge + " kg";
    }
}